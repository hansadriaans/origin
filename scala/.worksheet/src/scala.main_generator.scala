...
object main_generator {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(163); 
  ...
  };System.out.println("""goto_otravo: (webvisit: scala.main_generator.Webvisit)String""");$skip(488); 
  ...
  };System.out.println("""goto_website: (person: scala.main_generator.Person)String""");$skip(67); 
  ...
  //reisplanner ! nieuw_bezoek
   ...
   case class persoonlijk(person:Person);System.out.println("""persons  : List[scala.main_generator.Person] = """ + $show(persons ));$skip(181); 
